...
class MainShell extends StatelessWidget {
  ...
  static const _tabs = ['/dashboard', '/graphiques', '/alarmes', '/localisation', '/parametres'];
    ...
    return Scaffold(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.location_on_outlined),   selectedIcon: Icon(Icons.location_on),   label: 'GPS'),
